export const SORRY_RESPONSE =
    "My apologies, I don't understand! I will keep learning.";
...
export const HELP =
    'Okay, let me introduce myself. I know all the trending repositories on Github.';
export const COMMAND_INTRODUCE =
    'You can ask me "tell me the trending repositories on Github today or this week". If you are interested of a specific language, just ask me "the trending repositories for Javascript on Github today or this month". Try it now!';
...
export const EMPTY_REPOSITORY =
    'Ah! It seems there are no trending repositories on Github now.';
export const NETWORK_ERROR =
    'Oops! It seems we are experiencing network issues now! Please try again later!';
...
export const REPOSITORY_OTHER_LANGUAGE =
    'If you want to know the trending for a specific languages, just ask me "Tell me the trending repositories for Javascript today".';
...
export const SIGN_IN_ASK_FOR_TRANSFER =
    'Yes, I can star the repository for you on Github, but this feature requires you to link your Github account on a device with a display screen. I can transfer the Account Linking request to your phone and let you link your Github account there.';
export const SIGN_IN_TRANSFER_NO =
    "Okay, it's totally fine you don't want to go to another device to link your Github account. I can tell you more repositories even without account linking. Do you wish to continue on next repository?";
export const SIGN_IN_NOT_SUPPORTED =
    "It seems you don't have a device with a display screen, this feature is not available for your current device. But it's OK, you can continue to explore more repositories, do you wish to continue?";

export const REPOSITORY_NEXT_BUTTON = ['Explore more', 'Next', 'Go on'];
export const REPOSITORY_STAR_BUTTON = ['I Like it', 'Star it'];
export const REPOSITORY_GOODBYE_BUTTON = ['Not interested', 'No more'];
